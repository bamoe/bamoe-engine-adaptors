# IBM Business Automation Manager Open Editions - BAMOE Embedded Engine Adaptors
This repository includes a set of Java engine adaptors for implementing BAMOE in `Embedded Mode`.  
